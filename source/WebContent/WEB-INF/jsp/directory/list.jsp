...
<body marginwidth="0" marginheight="0" topmargin="2" leftmargin="0">
  ...
  <div style="background-color:#fafad2;margin-bottom:5px;">
    <div style="float:left;">
      <b>
        <a href="../article/create.do?id=<c:out value="${directory.id}"/>&docid=<c:out value="${directory.topicid}"/>" id="publishArticleForControl">文章发布</a>
  ...
  <div style="margin:13px 0"><div class="splitPageBar"><table align="center"><tbody><tr><td><select id="pagesize"><option value="20" selected="selected">20</option><option value="40" >40</option><option value="60" >60</option><option value="80" >80</option><option value="100" >100</option></select></td><td><span class="s1 s2">首页</span><span class="s1 s2">上页</span><a href="?topicid=00753E6D&source=&keyword=&userid=&lspri=&startday=&endday=&type=0&searchType=&pagex=1" class="cur" target="_self">1</a><span class="s1 s2">下页</span><span class="s1 s2">末页</span></td></tr></tbody></table></div></div>
  <div id="foot">
